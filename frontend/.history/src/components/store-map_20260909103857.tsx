  ...
  return (
    <div className="cdx-map relative h-[500px] w-full overflow-hidden rounded-tl-[2rem] rounded-br-[2rem] md:h-[440px]">
      {isLoaded && coords ? (
        ...
        {/* Floating panel */}
        <div className="pointer-events-none absolute inset-x-0 top-0 z-10 flex justify-center p-3 md:pointer-events-auto md:inset-auto md:left-10 md:top-10 md:block md:w-[22rem] md:p-0">
